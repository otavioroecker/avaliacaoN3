  ...
  connectedCallback() {
    this.innerHTML = `
      ...
      <div class="barra-lateral" id="barra-lateral">
        ...
        <a href="Visual/SerieAPaginaPrincipal.html" class="a-barra-lateral">Times Série A</a>
        <div class="linha"></div>
        <a href="Visual/SerieBPaginaPrincipal.html" class="a-barra-lateral">Times Série B</a>
        <div class="linha"></div>
        <a href="Visual/EuropaPaginaPrincipal.html" class="a-barra-lateral">Fut. Europeu</a>
        <div class="linha"></div>
        <a href="Visual/FutebolPaginaPrincipal.html" class="a-barra-lateral">Futebol</a>
        <div class="linha"></div>
        <a href="Visual/BasquetePaginaPrincipal.html" class="a-barra-lateral">Basquete</a>
        <div class="linha"></div>
        <a href="Visual/VoleiPaginaPrincipal.html" class="a-barra-lateral">Vôlei</a>
        <div class="linha"></div>
        <a href="Visual/TenisPaginaPrincipal.html" class="a-barra-lateral">Tênis</a>
        <div class="linha"></div>
        <a href="Visual/SurfePaginaPrincipal.html" class="a-barra-lateral">Surfe</a>
        <div class="linha"></div>
        <a href="Visual/Formula1PaginaPrincipal.html" class="a-barra-lateral">Fórmula 1</a>
        <div class="linha"></div>
        <a href="Visual/PaginaSobre.html" class="a-barra-lateral">Sobre Nós</a>
      </div>
    `;
